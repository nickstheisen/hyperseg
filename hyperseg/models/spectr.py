...
class SpecTr(SemanticSegmentationModule):
    """
    ...
    def __init__(self, 
                    f_maps=64, 
                    layer_order='cgr',
                    choose_translayer=[0,1,1,1,0,0,0],tran_enc_layers=1,
                    num_groups=8, 
                    num_levels=4, 
                    final_sigmoid=True,
                    ...
                    conv_padding=(0,1,1),
                    max_seq=10, 
                    use_entmax15='entmax_bisect', 
                    **kwargs):
        super(SpecTr, self).__init__(**kwargs)
        ...
        for i, out_feature_num in enumerate(f_maps):
            ...
            if i == 0:
                encoder = AdaptivePool_Encoder(self.n_channels, out_feature_num,
        ...
        self.final_conv = nn.Conv3d(f_maps[0], self.n_classes, 1)
        if final_sigmoid:
