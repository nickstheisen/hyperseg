...
class UNetDropout(SemanticSegmentationModule):
    def __init__(self, 
            bilinear : bool = True,
            ...
            dropout : float = 0.0,
            **kwargs):
        super(UNetDropout, self).__init__(**kwargs)
        ...
        self.down1 = Down(64, 128, batch_norm=self.batch_norm,dropout= self.dropout)
        self.down2 = Down(128, 256, batch_norm=self.batch_norm, dropout=self.dropout)
        self.down3 = Down(256, 512, batch_norm=self.batch_norm, dropout = self.dropout)
